...
{
    return 1.0 / tan( apparent_el + 7.31 * M_PI / 180.0 /
                                        ( apparent_el + 4.4 * M_PI / 180.0 ) );
}
...
{
    double x = 283 * pressure / ( 101 * ( 273 + temp ) );
    return x / tan( apparent_el + 7.31 * M_PI / 180.0 /
                                      ( apparent_el + 4.4 * M_PI / 180.0 ) );
}
...
{
    return el_rate *
           ( 1 + predict_refraction_rate_ext( el, el_rate, pressure, temp ) );
}
